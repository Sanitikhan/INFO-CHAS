            ...
            <ul class="nav-list primary-nav">
                ...
                <li class="nav-item dropdown-container">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item">
                            <a href="livraisons.php" class="nav-linkdropdown-link">Toutes les livraisons</a>
                        </li>
                        <li class="nav-item">
                            <a href="meslivraisons.php" class="nav-link active  dropdown-link">Mes livraisons</a>
                        </li>
                    </ul>
                </li>
                <!-- Dropdown -->
